...
public class RobotStateEstimator extends Command {
    ...
    DifferentialDrive drive_ = Hardware.getInstance().getChassis();
    ...
    public void execute() {
        ...
        final Twist2d predicted_velocity = Kinematics.forwardKinematics(drive_.getInchesPerSecond(DifferentialDrive.Side.LEFT),
